      ...
      <div className="hidden lg:flex flex-1 items-center justify-center p-12 relative overflow-hidden" style={{ background: 'var(--gradient-hero)' }}>
        ...
        >
          ...
          <p className="text-white/60 text-lg leading-relaxed mb-8">
            A plataforma gamificada do Sistema FIEAC. Aprenda, conquiste badges e lidere o ranking!
          </p>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 bg-background">
        ...
        >
          <div className="lg:hidden flex flex-col items-center mb-8">
            <img src={logoFieac} alt="Saber+" className="h-12 w-auto mb-3" />
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="email" type="email" placeholder="Seu email institucional" value={email} onChange={e => setEmail(e.target.value)} className="h-12 rounded-xl" required />
              </div>
              <div className="space-y-2">
            ...
            <p className="text-center text-xs text-muted-foreground">
              O cadastro é feito pelo administrador do sistema.
            </p>
          </div>
        </motion.div>
      </div>
